...
@section('contenido')
    <div class="card">
        <div class="card-header">
            <form class="form-inline" action="{{url('/rutaMateriaBuscarEliminar')}}" method="GET">
                {{csrf_field()}}
                ...
                @foreach($materias as $unaMateria)
                    <tr>
                        ...
                        <td class="project-actions text-right">
                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#modal{{$unaMateria->id}}">
                            ...
                            <div class="modal fade" id=modal{{$unaMateria->id}}>
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-footer justify-content-between">
                                        ...
                                        <form method="POST" action="/Materia/{{$unaMateria->id}}">
                                            @method('DELETE')
